...
plantButton.event:Connect(function()
    for i = 1, 1 do
        ...
        local ohCFrame2 = CFrame.new(Players.LocalPlayer.Character.HumanoidRootPart.Position.X,Players.LocalPlayer.Character.HumanoidRootPart.Position.Y-3,Players.LocalPlayer.Character.HumanoidRootPart.Position.Z+i, 0, 0, 0, 0, 1, 0, 0, 0, 0)
        local ohNumber3 = 0
