...
local plantButton = autofarmTab.new("Button", {text=" Plant Boxes "})
plantButton.event:Connect(function()
    for i = 1, 1 do
        local ohString1 = "Plant Box"
        local ohCFrame2 = CFrame.new(Players.LocalPlayer.Character.HumanoidRootPart.Position.X,Players.LocalPlayer.Character.HumanoidRootPart.Position.Y-0.1,Players.LocalPlayer.Character.HumanoidRootPart.Position.Z+i, 1, 0, 0, 0, 1, 0, 0, 0, 1)
        local ohNumber3 = 0
